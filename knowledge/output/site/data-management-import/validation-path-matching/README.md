...
Utilities for detecting supported raw file types, matching paths to experiments, ownership/readability checks, regex helpers and per-file annotation hooks.
