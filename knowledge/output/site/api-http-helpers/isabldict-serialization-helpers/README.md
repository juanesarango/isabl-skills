# IsablDict & Serialization Helpers

Utilities to convert arbitrary Python objects and nested dicts into IsablDict instances and Isabl-specific accessors (custom field access, popping and representations).
