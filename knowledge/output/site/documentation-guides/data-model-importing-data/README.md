# Data Model & Importing Data

Documentation describing Isabl's normalized data model (individuals, samples, experiments) and detailed import workflows for raw data and YAML manifests.
