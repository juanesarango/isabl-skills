# Importers & Import Workflows

Local import engines and batch import features to discover, match and commit raw files to experiments and to register reference resources for assemblies/techniques.
